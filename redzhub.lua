...
loadstring(game:HttpGet("https://raw.githubusercontent.com/viplam087-png/Hjj/main/AttackKill.lua"))()
...
if getgenv().Settings.JoinTeam then
    if game.Players.LocalPlayer:WaitForChild("PlayerGui"):FindFirstChild("Main (minimal)") then
        task.wait(2)
    ...
    pcall(function()
        if game:GetService("Players").LocalPlayer and game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid") and game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game:GetService("Players").LocalPlayer.Character.Humanoid.Health > 0 and game:GetService("Players").LocalPlayer.Character.HumanoidRootPart then
            ...
            if IngoreY and (b1.Position - targetCFrameWithDefualtY.Position).Magnitude > 5 then
                ...
                local aO = TweenInfo.new((targetPos - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).Magnitude / getgenv().TweenSpeed,Enum.EasingStyle.Linear)
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().TeleportIsland or getgenv().TeleportNPC or getgenv().AutoFarm or getgenv().AutoMaterial or getgenv().AutoFarmMasteryFruit or getgenv().AutoFarmMasteryGun or getgenv().AutoFarmMasteryAllSword or getgenv().AutoGetMelee or getgenv().TeleportToFruit or getgenv().AutoNewWorld or getgenv().AutoThirdSea or getgenv().AutoBartilo or getgenv().AutoTrainingDummy or getgenv().AutoFactory or getgenv().AutoPirateRaid or getgenv().AutoEliteHunter or getgenv().AutoUnHaki or getgenv().AutoAttackRipIndra or getgenv().AutoSoulReaper or getgenv().AutoDoughKing or getgenv().AutoAttackDoughKing or getgenv().AutoPhoenixRaid or getgenv().AutoDarkBladev3 or getgenv().AutoDarkbeard or getgenv().AutoAttackBossUnboundWerewolf or getgenv().DojoClaimQuest or getgenv().DragonTalonUpgrade or getgenv().AutoCollectBerry or getgenv().AutoFarmChest or getgenv().AutoFarmChestTp or getgenv().AutoLaw or getgenv().AutoObservationHakiV2 or getgenv().AutoObservation or getgenv().AutoKillMob or getgenv().AutoKillBoss or getgenv().AutoKillAllBoss or getgenv().AutoDungeon or getgenv().AutoTeleportLab or getgenv().TeleportNpcSea or getgenv().Autoterrorshark or getgenv().KillShark or getgenv().KillPiranha or getgenv().KillFishCrew or getgenv().TeleportToKitsuneIsland or getgenv().AutoStartKitsune or getgenv().CollectAzure or getgenv().TeleportFrozenDimension or getgenv().AutoAttackLeviathan or getgenv().TrialTeleportDraco or getgenv().AutoTrialDracoBeta or getgenv().AutoTrainDraco or getgenv().AutoDracoV2 or getgenv().AutoUpgradeRace or getgenv().TeleportAcientClock or getgenv().Race_1 or getgenv().QuestTrain or getgenv().TweenMigareIsland or getgenv().AutoTeleportHighestPoint or getgenv().AutoFarmChestMigareIsland or getgenv().TeleportAdvancedFruitDealer or getgenv().TweenToGear or getgenv().TeleportTrialDoor or getgenv().AutoTrialRace or getgenv().AutoKillPlayerAfterTrial or getgenv().AutoTeleportLegendarySwordDealer or getgenv().AutoTeleportBaristaCousin or getgenv().AutoRainBowHaki or getgenv().AutoSkullGuitar or getgenv().AutoGetCDK or getgenv().AutoTushita or getgenv().AutoHolyTorch or getgenv().AutoSaber or getgenv().FindPrehistoric or getgenv().TeleportToPrehistoricIsland or getgenv().AutoStartPrehistoric or getgenv().AutoDefendVolcano or getgenv().CollectBone or getgenv().CollectEgg or getgenv().TpPly then
                ...
                if game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip"):Destroy() end
                if game.Players.LocalPlayer.Character:FindFirstChild("highlight") then game.Players.LocalPlayer.Character:FindFirstChild("highlight"):Destroy() end
            end
        end)
    end
end)
...
DropFruits = function()
    for _, v3 in next, game.Players.LocalPlayer.Backpack:GetChildren() do
        if string.find(v3.Name, "Fruit") then
            EquipWeapon(v3.Name)
            if game.Players.LocalPlayer.PlayerGui.Main.Dialogue.Visible == true then
    ...
    for _, b2 in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
...
function UpdStFruit()
    for _, item in next, game.Players.LocalPlayer.Backpack:GetChildren() do
        local StoreFruit = item:FindFirstChild("EatRemote", true)
        if StoreFruit then
            local fruitName = item:GetAttribute("OriginalName") or item.Name
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", fruitName, item)
        end
    end
end
CheckF = function()
...
-- ImageButton.Image = "rbxassetid://133327881344796"
...
Discord:AddDiscordInvite({
    ...
    Logo = "rbxassetid://133327881344796",
    Invite = "https://discord.gg/tdtfreenokey"
})
local Codes = {
    "WildDares",
    "BossBuild",
...
Shop:AddButton({
    ...
    Callback = function()
        ...
        repeat wait()
        until (game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait().HumanoidRootPart.Position - Vector3.new(5814.42724609375, 1208.3267822265625, 884.5785522460938)).Magnitude < 1
        local args = {
            [1] = {
                ["NPC"] = "Dragon Wizard",
                ["Command"] = "DragonRace"
...
spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban")
            or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
...
spawn(function()
    pcall(function()
        while wait() do
            Bone:SetDesc("You Have : " .. tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones", "Check")) .. " Bones")
        end
    end)
end)
Status:AddTextBox({
...
Status:AddButton({
    ...
    Callback = function()
        ...
        local PlaceId = game.PlaceId
        local ServerAPI = Api .. PlaceId .. "/servers/Public?sortOrder=Asc&limit=100"
...
spawn(function()
    while wait() do
        if game.Players.LocalPlayer and game.Players.LocalPlayer:FindFirstChild("Data") and game.Players.LocalPlayer.Data:FindFirstChild("Points") then
            if game.Players.LocalPlayer.Data.Points.Value >= 1 and getgenv().AutoStats then
                local statTypes = {
                    Melee = "Melee",
                    Defense = "Defense",
                    Sword = "Sword",
...
LocalPlayer:AddToggle({
    ...
    Default = false,
    Callback = function(Value)
        getgenv().HideChat = Value
    end
})
spawn(function()
    while wait() do
        if getgenv().HideChat then
...
LocalPlayer:AddSlider({
    ...
    Default = 3000,
    Callback = function(Value)
        getgenv().DistanceFarmAura = Value
    end
})
LocalPlayer:AddToggle({
        ...
        pcall(function()
            if getgenv().SafeMode then
                if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    local HealthMinPlayer = game.Players.LocalPlayer.Character.Humanoid.MaxHealth * (getgenv().Safe / 100)
                    if game.Players.LocalPlayer.Character.Humanoid.Health <= HealthMinPlayer then
                        while getgenv().SafeMode and game.Players.LocalPlayer.Character.Humanoid.Health <= HealthMinPlayer do
                            task.wait()
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame + Vector3.new(0, getgenv().PosYSafeHealth or 15, 0)
                        end
                    end
                end
            end
...
Farm:AddDropdown({
    ...
    Options = { "Level Farm", "Farm Bones", "Farm Katakuri", "Farm Tyrant of the Skies"},
    Default = "Level Farm",
    Callback = function(Value)
                    ...
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        or v.Name == "Posessed Mummy" then
                            ...
                            and v.Humanoid.Health > 0 then
                                if getgenv().AcceptQuest and not game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible then
                                ...
                                repeat
                                    task.wait()
                                    Attack.Kill(v, getgenv().AutoFarm)
                                until not getgenv().AutoFarm or v.Humanoid.Health <= 0 or not v.Parent or (getgenv().AcceptQuest and not game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible)
                            end
                        end
                    end
                else
				...
				if v then
					...
					if v then
						...
						repeat
							task.wait()
							Attack.Kill(v, getgenv().AutoFarm)
						until not getgenv().AutoFarm or v.Humanoid.Health <= 0 or (getgenv().AcceptQuest and not game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible)
					else
...
Farm:AddToggle({
    ...
    Callback = function(Value)
        ...
        StopTween(getgenv().AutoFarmnear)
    end
})
spawn(function()
    while wait() do
        if getgenv().AutoFarmnear then
            pcall(function()
                for _, v in pairs(game.Workspace.Enemies:GetChildren()) do
                    ...
                    and v.Humanoid.Health > 0 then                        
                        ...
                        if distance <= getgenv().DistanceFarmAura then
                            repeat
                                task.wait()
                                Attack.Kill(v, getgenv().AutoFarmnear)                     
                            until not getgenv().AutoFarmnear or not v.Parent or v.Humanoid.Health <= 0 or not game.Workspace.Enemies:FindFirstChild(v.Name)
                        end
                    end
                end
            end)
...
local function EnsureRodAndBait()
    ...
    if FishingData and table.find({"None", nil}, FishingData:GetAttribute("SelectedBait")) then
        ...
        if CraftRF then
            for i = 1, (getgenv().BaitAmount or 1) do
...
local function GetCastPosition()
    ...
    local _, groundHit = Workspace:FindPartOnRayWithIgnoreList(Ray.new(hitPos + Vector3.new(0, 3, 0), Vector3.new(0, -500, 0)),{Character, Workspace.Characters, Workspace.Enemies})
...
Farm:AddSlider({
    Name = "Bait Craft Amount",
    Min = 1,
    Max = 100,
    Default = 1,
    Callback = function(Value)
        getgenv().BaitAmount = Value
    end
})
Farm:AddToggle({
    Name = "Auto Fishing",
                ...
                if game:GetService("Workspace").Enemies:FindFirstChild(getgenv().SelectBoss) then
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.Name == getgenv().SelectBoss and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            repeat task.wait()
                                Attack.Kill2(v,getgenv().AutoKillBoss)
    ...
    game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if getgenv().AutoFarmMasteryFruit or getgenv().AutoFarmMasteryGun or getgenv().AutoFarmMasteryAllSword then
                for _, v in pairs(game.Players.LocalPlayer:WaitForChild("PlayerGui"):WaitForChild("Notifications"):GetChildren()) do
    ...
    while wait() do
        pcall(function()
            if getgenv().AutoFarmMasteryAllSword then
                if getgenv().AutoMethodMastery == "Cake" then
                    for _, v in next, game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventory") do
                            ...
                            if v.Type == "Sword" then
                                ...
                                if tonumber(v.Mastery) >= 1 or tonumber(v.Mastery) <= 599 then
                                    ...
                                    if GetBP(SwordName) then
                                        ...
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LoadItem", SwordName)
                                    end
    ...
    while wait() do
        pcall(function()
            if getgenv().GetMode == "GodHuman" and getgenv().AutoGetMelee and World3 then
                local result = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman", true)
                        ...
                        if workspace.Enemies:FindFirstChild("Ice Admiral") then
                            for _, xz in pairs(workspace.Enemies:GetChildren()) do
                                if xz.Name == "Ice Admiral" and Attack.Alive(xz) then
                                    repeat
                                        task.wait()
                                        Attack.Kill2(xz, getgenv().AutoNewWorld)
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 3 then
                        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ~= nil then
                            ...
                            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ZQuestProgress", "Check") == 0 then
                                ...
                                if v then
                                    repeat task.wait()
                                        Attack.Kill2(v,getgenv().AutoThirdSea)
                            ...
                            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil then
                                ...
                                for i,v in next, game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits") do
                        ...
                        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 0 then
                            ...
                            and game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then                                
                                local v = GetConnectionEnemies("Swan Pirate")
                                if v then
                                    pcall(function()
                                        repeat task.wait()
                                            Attack.Kill(v,getgenv().AutoThirdSea)
                                        until not v.Parent or v.Humanoid.Health <= 0 or getgenv().AutoThirdSea == false or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    end)
                                else
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().AutoBartilo and game.Players.LocalPlayer.Data.Level.Value >= 850 then
                ...
                if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
                    if Qbart.Visible == true then
                        ...
                        until ((CFrame.new(-461.533203, 72.3478546, 300.311096,0.050853312, 0, -0.998706102,0, 1, 0,0.998706102, 0, 0.050853312).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 20) or getgenv().AutoBartilo == false
                ...
                elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 1 then
                    ...
                    if je then
                        repeat task.wait()
                            Attack.Kill2(je, getgenv().AutoBartilo)
                ...
                elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 2 then
                    ...
                    until ((CFrame.new(-1830.83972, 10.5578213, 1680.60229,0.979988456, -2.02152783e-08, -0.199054286,2.20792113e-08, 1, 7.1442483e-09,0.199054286, -1.13962431e-08, 0.979988456).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1) or getgenv().AutoBartilo == false
                    task.wait(0.5)
        ...
        if getgenv().AutoTrainingDummy then
            pcall(function()
                if game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(xxx))
                else
            ...
            pcall(function()
                ...
                if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - Root.Position).Magnitude <= 500 then
                    ...
                    local Castle_Mob = {
                        ...
                        "Zombie", "Snow Trooper", "Winter Warrior", "Lab Subordinate", "Horned Warrior",
                            ...
                            for i, v in pairs(enemies:GetChildren()) do
                                if (v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban") and 
                                   ...
                                   v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        Attack.Kill2(v, getgenv().AutoEliteHunter)
                                    until getgenv().AutoEliteHunter == false or v.Humanoid.Health <= 0 or not v.Parent
                                end
                            end
                        else
                            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") then
                                topos(game:GetService("ReplicatedStorage").Diablo.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
                                topos(game:GetService("ReplicatedStorage").Deandre.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                            elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
                                topos(game:GetService("ReplicatedStorage").Urban.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                            end
                        end
                    end
                else
...
local function AuraSkin(HakiID)
    ...
    game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/FruitCustomizerRF"):InvokeServer(args[1])
end
                ...
                if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form") or game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        and v.Humanoid.Health > 0 then
                            repeat task.wait()
                                pcall(function()
                                    Attack.Kill2(v, getgenv().AutoAttackRipIndra)
                                end)
        ...
        if getgenv().AutoSoulReaper and World3 then
            pcall(function()
                ...
                if v then
                    repeat 
                        task.wait()
                        Attack.Kill2(v,getgenv().AutoSoulReaper)
                    ...
                    if not GetBP("Hallow Essence") then
                        ...
                        repeat 
                            task.wait(0.1)
                            topos(summonPos)
                        until not getgenv().AutoSoulReaper or (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - summonPos.Position).Magnitude < 5)
			...
			pcall(function()
				...
				elseif workspace.Map.CakeLoaf:FindFirstChild("RedDoor") then
					if GetBP("Red Key") then
						...
						until not getgenv().AutoDoughKing or (game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame - CFrame.new(-2681.97998, 64.3921585, -12853.7363)).Magnitude <= 5
						EquipWeapon("Red Key")
					end
				elseif GetConnectionEnemies("Dough King") then
					...
					if v then
						repeat
							task.wait()
							Attack.Kill2(v, getgenv().AutoDoughKing)
				...
				if not game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice")
					or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
        ...
        if getgenv().AutoAttackDoughKing and World3 then
            pcall(function()
                ...
                if v then
                    repeat 
                        task.wait()
                        Attack.Kill2(v,getgenv().AutoAttackDoughKing)
            ...
            pcall(function()
                if GetBP("Bird-Bird: Phoenix") then
                    if game.Players.LocalPlayer.Backpack:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value) then
                        if game.Players.LocalPlayer.Backpack[game.Players.LocalPlayer.Data.DevilFruit.Value].Level.Value >= 400 then
                    ...
                    elseif game.Players.LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value) then
                        if game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Data.DevilFruit.Value].Level.Value >= 400 then
                            topos(CFrame.new(-2812.76708984375, 254.803466796875, -12595.560546875))
                            if (CFrame.new(-2812.76708984375, 254.803466796875, -12595.560546875).Position 
                                - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10 then
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist", "Check")
            ...
            pcall(function()
                ...
                elseif GetConnectionEnemies("Darkbeard") then
                    ...
                    if v then
                        repeat
                            task.wait()
                            Attack.Kill2(v,getgenv().AutoDarkbeard)
...
Other:AddSection("Halloween Event")
Other:AddToggle({
    Name = "Auto Farm Trick Or Treat [ Beta ]",
    Description = "It May Also Not Work Because This Is Beta",
    Default = false,
    Callback = function(Value)
        getgenv().AutoFarmTrickOrTreat = Value
    end
})
Other:AddToggle({
    Name = "Auto Attack Boss Unbound Werewolf Event",
    Default = false,
    Callback = function(Value)
        getgenv().AutoAttackBossUnboundWerewolf = Value
        StopTween(getgenv().AutoAttackBossUnboundWerewolf)
    end
})
spawn(function()
    while wait() do
        if getgenv().AutoAttackBossUnboundWerewolf then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Unbound Werewolf") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.Name == "Unbound Werewolf" then
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                repeat task.wait()
                                    Attack.Kill2(v, getgenv().AutoAttackBossUnboundWerewolf)
                                until not getgenv().AutoAttackBossUnboundWerewolf or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    end
                else
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Unbound Werewolf") then
                        topos(game:GetService("ReplicatedStorage"):FindFirstChild("Unbound Werewolf").HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))
                    end
                end
            end)
        end
...
Other:AddToggle({
    Name = "Auto Random Candy Corn",
    Default = false,
    Callback = function(Value)
        getgenv().AutoTradeCandyCorn = Value
    end
})
...
Other:AddToggle({
    ...
    Default = false,
    Callback = function(Value)
        getgenv().AutoFarmChestTp = Value
    end
})
spawn(function()
    while wait() do
        if getgenv().AutoFarmChestTp then
            local Players = game:GetService("Players")
            local CollectionService = game:GetService("CollectionService")
            local Player = Players.LocalPlayer
            local Character = Player.Character or Player.CharacterAdded:Wait()
...
Other:AddToggle({
    Name = "Stop Items - Chest",
    Description = "Enable This To Stop On Getting Fist of Darkness Or God's Chalice",
    Default = false,
    Callback = function(Value)
        getgenv().StopItemChest = Value
    end
})
spawn(function()
    while wait() do
        if getgenv().StopItemChest then
            pcall(function()
                if GetBP("God's Chalice")
                or GetBP("Fist of Darkness") then
                    getgenv().AutoFarmChest = false
                    getgenv().AutoFarmChestTp = false
                end
            end)
        end
    end
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Order") then
                        for _, i in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if i.Name == "Order" then
                                repeat task.wait()
                                    Attack.Kill2(i,getgenv().AutoLaw)
    ...
    while wait() do
        if getgenv().AutoObservationHakiV2 then
            pcall(function()
                ...
                if game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true 
                    and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Defeat 50 Forest Pirates") then
                    local v = GetConnectionEnemies("Forest Pirate")
                    if v then
                        repeat task.wait()
                            Attack.Kill(v,getgenv().AutoObservationHakiV2)
                        until not getgenv().AutoObservationHakiV2 or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
                    else
                        topos(Kv2Pos4)
                    end
                elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if v then
                        repeat task.wait()
                            Attack.Kill2(v,getgenv().AutoObservationHakiV2)
                        until not getgenv().AutoObservationHakiV2 or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
                    else
                        topos(Kv2Pos5)
                    end
                ...
                if not game.Players.LocalPlayer.Backpack:FindFirstChild("Fruit Bowl") 
                    or not game.Players.LocalPlayer.Character:FindFirstChild("Fruit Bowl") then
                    ...
                    if (game.Players.LocalPlayer.Backpack:FindFirstChild("Banana") and game.Players.LocalPlayer.Backpack:FindFirstChild("Apple") and game.Players.LocalPlayer.Backpack:FindFirstChild("Pineapple"))
                        or (game.Players.LocalPlayer:FindFirstChild("Banana") and game.Players.LocalPlayer:FindFirstChild("Apple") and game.Players.LocalPlayer:FindFirstChild("Pineapple")) then
                        repeat task.wait()
                            topos(Kv2Pos1)
                        until getgenv().AutoObservationHakiV2 or game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame == Kv2Pos1           
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress", "Citizen")
                    end
                end
            ...
            if getgenv().AutoObservation then
                if World1 then
                    ...
                    if enemy then
                        if KenTest then
                            repeat task.wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = enemy.HumanoidRootPart.CFrame * CFrame.new(3, 0, 0)
                            until not getgenv().AutoObservation or not KenTest
                        else
                            repeat task.wait()
                                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = enemy.HumanoidRootPart.CFrame * CFrame.new(0, 50, 0)
    ...
    while wait() do
        pcall(function()
            if getgenv().AutoDungeon then
                local raidUI = game.Players.LocalPlayer.PlayerGui.Main.TopHUDList.RaidTimer
                if raidUI and not raidUI.Visible then
                ...
                if raidUI and raidUI.Visible == true then
                    ...
                    if hrp then
                        for _, enemy in pairs(workspace.Enemies:GetChildren()) do
                            ...
                            if humanoid and hrpEnemy and humanoid.Health > 0 then
                                local dist = (hrpEnemy.Position - hrp.Position).Magnitude
                                if dist <= 800 then
                                    repeat
                                        task.wait()
                                        if not getgenv().AutoDungeon then break end
                                        pcall(function()
                                            Attack.Kill(enemy, getgenv().AutoDungeon)
                                        end)
                                    until not enemy.Parent or humanoid.Health <= 0 or not getgenv().AutoDungeon
                                end
                            end
                        end
                    end
...
game:GetService("RunService").RenderStepped:Connect(function()
    if getgenv().SpeedBoat then
        if game:GetService("Players").LocalPlayer and game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid") then
            if LocalPlayer.Character.Humanoid.Sit then
                for _, boat in pairs(game:GetService("Workspace").Boats:GetChildren()) do
                    if boat:FindFirstChildWhichIsA("VehicleSeat") then
                        boat:FindFirstChildWhichIsA("VehicleSeat").MaxSpeed = SetSpeedBoat
                    end
                end
            end
        end
...
spawn(function()
    while wait() do
        if getgenv().TeleportNpcSea and World3 then
            ...
            elseif getgenv().NpcMode == "Beast Hunter" then
            ...
            elseif getgenv().NpcMode == "Shark Hunter" then
            ...
            elseif getgenv().NpcMode == "Shipwright Teacher" then
...
spawn(function()
    while wait() do
        if getgenv().TeleportToKitsuneIsland then
            if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
                topos(game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland").ShrineActive.NeonShrinePart.CFrame * CFrame.new(0, 0, 10))
            end
        end
    end
end)
                ...
                if shrineActive then
                    for _, v in next, shrineActive:GetDescendants() do
                        if v:IsA("BasePart") and v.Name:find("NeonShrinePart") then
                            ...
                            until getgenv().AutoStartKitsune == false or not kit_is
                        end
                    end
                else
                    topos(workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island").CFrame * CFrame.new(0, 500, 0))
                end
            end)
        end
    end
        ...
        if getgenv().CollectAzure then
            pcall(function()
                if workspace:WaitForChild("AttachedAzureEmber") or workspace:WaitForChild("EmberTemplate") then
                    topos(workspace:WaitForChild("EmberTemplate"):FindFirstChild("Part").CFrame)
                else
                    topos(workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island").CFrame * CFrame.new(0, 500, 0))
...
spawn(function()
    while wait() do
        if getgenv().TeleportFrozenDimension then
            pcall(function()
                if workspace.Map:FindFirstChild("LeviathanGate") then
                    topos(workspace.Map.LeviathanGate.CFrame)
...
spawn(function()
    while wait() do
        if getgenv().TrialTeleportDraco then
            local TeleportDraco = workspace.Map.PrehistoricIsland:FindFirstChild("TrialTeleport")
            if (TeleportDraco and TeleportDraco:IsA("Part")) then
                topos(CFrame.new(TeleportDraco.Position))
            end
        end
    end
end)
        ...
        if getgenv().AutoTrialDracoBeta then
            pcall(function()
                ...
                if workspace.Map:FindFirstChild("DracoTrial") then
                    ...
                    until not getgenv().AutoTrialDracoBeta or (Root.Position == CFrame.new(-39934.9765625, 10685.359375, 22999.34375).Position)
                    repeat
                        task.wait()
                        topos(CFrame.new(-40511.25390625, 9376.4013671875, 23458.37890625))
                    until not getgenv().AutoTrialDracoBeta or (Root.Position == CFrame.new(-40511.25390625, 9376.4013671875, 23458.37890625).Position)
                    wait(2.5)
                    repeat
                        task.wait()
                        topos(CFrame.new(-39914.65625, 10685.384765625, 23000.177734375))
                    until not getgenv().AutoTrialDracoBeta or (Root.Position == CFrame.new(-39914.65625, 10685.384765625, 23000.177734375).Position)
                    repeat
                        task.wait()
                        topos(CFrame.new(-40045.83203125, 9376.3984375, 22791.287109375))
                    until not getgenv().AutoTrialDracoBeta or (Root.Position == CFrame.new(-40045.83203125, 9376.3984375, 22791.287109375).Position)
                    wait(2.5)
                    repeat
                        task.wait()
                        topos(CFrame.new(-39908.5, 10685.4052734375, 22990.04296875))
                    until not getgenv().AutoTrialDracoBeta or (Root.Position == CFrame.new(-39908.5, 10685.4052734375, 22990.04296875).Position)
                    repeat
                        task.wait()
                        topos(CFrame.new(-39609.5, 9376.400390625, 23472.94335975))
                    until not getgenv().AutoTrialDracoBeta or (Root.Position == CFrame.new(-39609.5, 9376.400390625, 23472.94335975).Position)
                else
    ...
    while wait() do
        pcall(function()
            if getgenv().AutoTrainDraco then
                ...
                for i = 1, #DragoM do
                    local raceEnergy = game.Players.LocalPlayer.Character:FindFirstChild("RaceEnergy")
            ...
            if FireFlower then
                for _, flower in pairs(FireFlower:GetChildren()) do
                    if flower:IsA("Model") and flower.PrimaryPart then
                        ...
                        local playerRoot = game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character.HumanoidRootPart.Position
                        if playerRoot then
            ...
            if getgenv().UpgradeRaceMethod == "Race Human" and getgenv().AutoUpgradeRace then
                if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1") ~= -2 then
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1") == 0 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "2")
                    elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1") == 1 then
                        if not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 1") 
                        and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 1") then
                            topos(workspace.Flower1.CFrame)
                        elseif not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 2") 
                        and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 2") then
                            topos(workspace.Flower2.CFrame)
                        elseif not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 3") 
                        and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 3") then
                            local v = GetConnectionEnemies("Swan Pirate")
                            if v then
                                repeat task.wait()
                                    Attack.Kill(v,getgenv().AutoUpgradeRace)
                                until game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 3") or not v.Parent or v.Humanoid.Health <= 0 or getgenv().AutoUpgradeRace == false
                            else
                ...
                elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad", "1") == 1 then
                    ...
                    if v then
                        repeat task.wait()
                            Attack.Kill2(v,getgenv().AutoUpgradeRace)
            ...
            if getgenv().NoFrog and World3 then
                pcall(function()
                    ...
                    if game:GetService("Lighting"):FindFirstChild("Sky") then
                        game:GetService("Lighting"):FindFirstChild("Sky"):Destroy()
                    end
                end)
            end
            task.wait(1)
...
Race:AddToggle({
    ...
    Callback = function(Value)
        ...
        getgenv().QuestTrain = Value
        StopTween(getgenv().QuestTrain)
    end
})
spawn(function()
    pcall(function()
        while wait() do
            if getgenv().Race_1 then
                if game.Players.LocalPlayer.Character.RaceTransformed.Value == true then
                    getgenv().QuestTrain = false
                ...
                or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        or v.Name == "Posessed Mummy" then
                            ...
                            and v.Humanoid.Health > 0 then
                                repeat task.wait()
                                    Attack.Kill(v, getgenv().getgenv().QuestTrain)            
                                until not getgenv().QuestTrain or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    end
                else
...
spawn(function()
    pcall(function()
        while wait() do
            CheckTier:SetDesc(" Tiers Gear - V4 : " .. game.Players.LocalPlayer.Data.Race.C.Value)
        end
    end)
end)
Race:AddToggle({
...
spawn(function()
    pcall(function()
        while wait() do
            if getgenv().TweenMigareIsland then
...
Race:AddToggle({
    Name = "Auto Chest Migare Island",
    Default = false,
    Callback = function(Value)
        getgenv().AutoFarmChestMigareIsland = Value
        StopTween(getgenv().AutoFarmChestMigareIsland)
    end
})
spawn(function()
    while wait() do
        if getgenv().AutoFarmChestMigareIsland then
            pcall(function()
...
function MoveCamtoMoon()
    ...
    if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position, game.Players.LocalPlayer.Character.HumanoidRootPart.Position + moonDirection)
    end
end
spawn(function()
    while wait() do
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().TeleportTrialDoor and game.Players.LocalPlayer and game.Players.LocalPlayer:FindFirstChild("Data") and game.Players.LocalPlayer.Data:FindFirstChild("Race") then
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().AutoTrialRace and tostring(game.Players.LocalPlayer.Data.Race.Value) == "Mink" then
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().AutoTrialRace and tostring(game.Players.LocalPlayer.Data.Race.Value) == "Fishman" then
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().AutoTrialRace and tostring(game.Players.LocalPlayer.Data.Race.Value) == "Cyborg" then
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().AutoTrialRace and tostring(game.Players.LocalPlayer.Data.Race.Value) == "Skypiea" then
...
spawn(function()
    while wait() do
        pcall(function()
            if getgenv().AutoTrialRace and (tostring(game.Players.LocalPlayer.Data.Race.Value) == "Human" or tostring(game.Players.LocalPlayer.Data.Race.Value) == "Ghoul") then
...
spawn(function()
    while wait() do
        if getgenv().AutoTeleportLegendarySwordDealer then
            pcall(function()
                for _, v in pairs(game:GetService("ReplicatedStorage").NPCs:GetChildren()) do
    ...
    pcall(function()
        while wait() do
            if getgenv().AutoRainBowHaki then
                ...
                elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true 
                    and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Stone") then
                    local v = GetConnectionEnemies("Stone")
                    if v then
                        repeat wait()
                            Attack.Kill(v,getgenv().AutoRainBowHaki) 
                        until getgenv().AutoRainBowHaki == false or v.Humanoid.Health <= 0 or not v.Parent or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
                    else
                        topos(CFrame.new(-1086.11621, 38.8425903, 6768.71436))
                    end
                elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true 
                    and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Hydra Leader") then
                ...
                elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true 
                    and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Kilo Admiral") then
                ...
                elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true 
                    and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Captain Elephant") then
                    local v = GetConnectionEnemies("Captain Elephant")
                    if v then
                        repeat task.wait()
                            Attack.Kill(v,getgenv().AutoRainBowHaki)
                ...
                elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true 
                    and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Beautiful Pirate") then
                    local v = GetConnectionEnemies("Captain Elephant")
                    if v then
                        repeat task.wait()
                            Attack.Kill(v,getgenv().AutoRainBowHaki)
    ...
    while wait() do
        pcall(function()
            if getgenv().AutoSkullGuitar then
                ...
                local progress = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GuitarPuzzleProgress", "Check")
                ...
                elseif not progress.Trophies then
                    ...
                    for i = 1, 5 do
                        ...
                        if data[1] then
                            ...
                            until rotation == data[2] or rotation == getTrophies(1)[3] or not getgenv().AutoSkullGuitar or game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GuitarPuzzleProgress", "Check").Trophies
                        end
                    end
                elseif not progress.Pipes then
                    ...
                    local function solvePipe(partIndex)
                        ...
                        if part.BrickColor ~= pipePart.BrickColor then
                            ...
                            until part.BrickColor == pipePart.BrickColor or not getgenv().AutoSkullGuitar or game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GuitarPuzzleProgress", "Check").Pipes
                        end
                    end
                    solvePipe(10)
                    solvePipe(8)
        ...
        if getgenv().AutoTushita then
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Longma") then
                    ...
                    local boss = game:GetService("ReplicatedStorage"):FindFirstChild("Longma")
                    if boss then
                    ...
                    if Workspace.Map.Jungle.QuestPlates.Door.Transparency == 0 then
                        ...
                        if Workspace.Map.Desert.Burn.Part.Transparency == 0 then
                            ...
                            if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ProQuestProgress", "SickMan") ~= 0 then
                                ...
                                EquipWeapon("Cup")
                                wait(0.5)
                                game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ProQuestProgress", "FillCup", LocalPlayer.Character.Cup)
                                wait(0)
                                game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ProQuestProgress", "SickMan")
                            else
                                local richSon = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon")
                                if richSon == nil then
...
spawn(function()
    while wait() do
        if getgenv().TeleportToPrehistoricIsland then
            pcall(function()
                ...
                if prehistoricIsland then
                    if workspace.Map:FindFirstChild("PrehistoricIsland", true) then
                        ...
                        if promptPart and promptPart:FindFirstChild("ProximityPrompt") then
                            if game.Players.LocalPlayer:DistanceFromCharacter(promptPart.CFrame.Position) <= 150 then
                ...
                for _, v in pairs(game.Workspace.Map.PrehistoricIsland.Core.VolcanoRocks:GetChildren()) do
                    if v:FindFirstChild("VFXLayer") then
                        if v:FindFirstChild("VFXLayer").At0.Glow.Enabled == true or v.VFXLayer.At0.Glow.Enabled == true then
                            ...
                            until not getgenv().AutoDefendVolcano or v:FindFirstChild("VFXLayer").At0.Glow.Enabled == false or v.VFXLayer.At0.Glow.Enabled == false
                        end
                    end
                end
            end
        ...
        pcall(function()
            if getgenv().CollectEgg then
                if workspace.Map.PrehistoricIsland.Core.SpawnedDragonEggs:FindFirstChild("DragonEgg") then
                    topos(workspace.Map.PrehistoricIsland.Core.SpawnedDragonEggs.DragonEgg.Molten.CFrame)
    ...
    while wait() do
        pcall(function()
            if getgenv().AutoAimbotCamera then
                ...
                local function closestplayer()
                    ...
                    for _, v in next, game.Players:GetPlayers() do
                        if v ~= game.Players.LocalPlayer then
                            if v.Character and v.Character:FindFirstChild("Head") and v.Character.Humanoid.Health > 0 then
                ...
                until getgenv().AutoAimbotCamera == false
            end
        end)
    end
end)
